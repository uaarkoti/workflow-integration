...
# install mock security realm plugin
...
# RUN sed -i 's/<Connector port=\"8080\"/<Connector port=\"8180\"/g' /usr/local/tomcat/conf/server.xml
# RUN sed -i 's/<Connector port=\"8009\"/<Connector port=\"8109\"/g' /usr/local/tomcat/conf/server.xml
